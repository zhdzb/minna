...
describe('agentStudyContextWriter', () => {
  it('generates next-agent-context from the seeded study state', () => {
    ...
    expect(result.content).toContain('最新 daily：study/daily/2026-07-21.json')
    expect(result.content).toContain('最新 review：study/reviews/2026-07-21-review.json')
    expect(result.content).toContain('最新 prompt：study/prompts/generated/2026-07-21-review.md')
    expect(result.content).toContain('study/prompts/generated/2026-07-21-review.md')
    expect(result.content).toContain('study/reviews/2026-07-21-review.json')
